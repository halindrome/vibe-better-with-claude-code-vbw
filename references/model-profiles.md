...
## Overview
VBW spawns 6 specialized agents (Lead, Dev, QA, Scout, Debugger, Architect) via the Task tool. Model profiles determine which Claude model each agent uses. Three preset profiles cover common use cases, with per-agent overrides for advanced customization.
...
| Profile | Lead | Dev | QA | Scout | Est. Cost/Phase | vs Quality |
|---------|------|-----|----|----|-----------------|------------|
| Quality | opus | opus | sonnet | haiku | $2.80 | 100% |
