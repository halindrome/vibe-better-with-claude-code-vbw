...
- **B6: CLAUDE.md** -- Generate project root CLAUDE.md: `# {project-name}` + `**Core value:** {one-liner}` + sections (Active Context, Key Decisions, Installed Skills, Project Conventions, Learned Patterns, VBW Commands). Max 200 lines. Regenerate on each update.
...
8. Regenerate CLAUDE.md: update Active Context, remove shipped refs. Preserve patterns.
