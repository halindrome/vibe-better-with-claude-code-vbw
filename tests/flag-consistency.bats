...
@test "every boolean flag in defaults.json is in rollout-stages.json or explicitly unmanaged" {
  ...
  local unmanaged_allowlist="auto_commit auto_install_skills branch_per_milestone context_compiler discovery_questions plain_summary skill_suggestions worktree_isolation"
